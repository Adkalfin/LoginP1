...
Route::put('accept-account/{id}', [AuthController::class, 'acceptAccount'])->withoutMiddleware(['auth:sanctum']);
Route::put('reject-account/{id}', [AuthController::class, 'rejectAccount'])->withoutMiddleware(['auth:sanctum']);
